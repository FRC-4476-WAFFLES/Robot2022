...
public class ThreeBallAutoComplete extends SequentialCommandGroup {
  ...
  public ThreeBallAutoComplete() {
    ...
    addCommands(new ShotComplete(Setup.FENDER_HIGH), new ThreeBallAutoPath().deadlineWith(new IntakeAuto(1.0)), new WaitCommand(0.5), new ShotComplete(Setup.FENDER_HIGH));
  }
}
